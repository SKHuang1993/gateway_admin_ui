                          ...
                          <div class="grid-content bg-purple-light">
                            <el-form-item label="">
                              <el-checkbox-group v-model.Boolean="validations.required" style="color: #666666">
                                ...
                                <a style="float: right;font-size: 12px;color: #999999;cursor: pointer" @click="DEL_PRIMARY(index,indexss)" v-if="indexss > 0">移除参数</a>
                              </el-checkbox-group>
                            </el-form-item>
                          </div>
                        </el-col>
...
<script>
    import{Clusters,ApisCreate} from "@/api/index"
    export default {
        name: 'App',
        data() {
        ...
        methods: {
          ...
          create(data){
            ...
            this.form.nodes.forEach(function (items,index) {
                ...
                if(items.validations.length == 0){
                  delete items.validations;
                }
            })
